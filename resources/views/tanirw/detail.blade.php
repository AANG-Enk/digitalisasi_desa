...
@section('title')
    {{ $tanirw->judul }} - Digitalisasi Desa
@endsection
...
<div class="d-flex justify-content-end">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">{{ $tanirw->judul }}</li>
        </ol>
    </nav>
</div>
    ...
    <div class="col-12">
      <div class="card mb-6">
        <div class="user-profile-header-banner">
          <img src="{{ asset('storage/'.$tanirw->image) }}" alt="Thumbnail Tani RW {{ $tanirw->judul }}" class="rounded-top" />
        </div>
          ...
          <div class="flex-grow-1 mt-4 mt-sm-12">
            <div
              ...
              <div class="user-profile-info">
                <h4 class="mb-2">{{ $tanirw->pembuat->name }}</h4>
                <ul
                  ...
                  <li class="list-inline-item">
                    ...
                    ><span class="fw-medium"> {{ \Carbon\Carbon::parse($tanirw->published_at)->isoFormat('DD-MMMM-YYYY') }}</span>
                  </li>
                </ul>
              </div>
              <a href="{{ route('tanirw.index') }}" class="btn btn-danger">
