...
@section('title')
    @if (isset($laporrw))
        Edit Laporan {{ $laporrw->judul }} - Digitalisasi Desa
    @else
        Tambah Laporan - Digitalisasi Desa
    @endif
@endsection
...
<div class="d-flex justify-content-end">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            @if (isset($laporrw))
                <li class="breadcrumb-item active">Edit Laporan {{ $laporrw->judul }}</li>
            @else
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-sm-10">
                            <input
                                ...
                                id="judul"
                                name="judul"
                                value="{{ isset($laporrw) ? old('judul',$laporrw->judul) : old('judul') }}"
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-sm-10">
                            ...
                            <div id="editor-container" style="height: 300px;" class="@error('deskripsi') is-invalid @enderror">
                                {!! isset($laporrw) ? old('deskripsi',$laporrw->deskripsi) : old('deskripsi') !!}
                            </div>
                            <textarea id="content" name="deskripsi" style="display: none;">{!! isset($laporrw) ? old('deskripsi',$laporrw->deskripsi) : old('deskripsi') !!}</textarea>
                            @error('deskripsi')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
